...
public class DaoHistoria implements CrudHistoria {
    ...
    @Override
    public List<ProductoDetalleFactura> obtenerDetallesProductos(int idFactura) {
    ...
    @Override
    public List<ProductoDetalleFactura> obtenerDetallesPromocion(int idFactura) {
        List<ProductoDetalleFactura> lista = new ArrayList<>();
    ...
    public List<ProductoDetalleFactura> obtenerDetallesCompra(int idFactura) {
        ...
        List<ProductoDetalleFactura> productos = obtenerDetallesProductos(idFactura);
        if (productos != null) {
            listaCompleta.addAll(productos);
        }
        // Obtener promociones de la factura
        List<ProductoDetalleFactura> promociones = obtenerDetallesPromocion(idFactura);
        if (promociones != null) {
