...
public class FechasComponente extends RoundedPanel {
    ...
    public FechasComponente(int radius, int borderHex, String tipo, String nombreInforme) {
        ...
        titulo.setFont(fuente.fuente(5, true));
        titulo.setForeground(Color.black);
        titulo.setBounds(10, 10, 180, 20);
        this.add(titulo);
        ...
        fechaInicio.setBounds(10, 40, 180, 50);
        ...
        fechaFin.setBounds(10, fechaInicio.getY() + 60, 180, 50);
        ...
        generar.setBounds(10, fechaFin.getY() + 60, 180, 40);
    ...
    public void agregarBtnDescargarInforme(String tipo){
        ...
        descargar.setBounds(10, generar.getY() + 45, 180, 40);
