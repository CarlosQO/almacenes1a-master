...
public class PaginaListarProveedores extends JFrame {
    ...
    public PaginaListarProveedores() {
        super("Proveedores");
        setSize(1300, 700);
        ...
        noHayProvee.setText("No hay proveedores");
        ...
        String[] columnas = { "<html><p>Nombres<br>Completos</p></html>", "Cedula",
                ...
                "Dirección", "Telefono", "Correo", "Estado" };
        ...
        tablaProveedores.getColumnModel().getColumn(6).setPreferredWidth(30);
